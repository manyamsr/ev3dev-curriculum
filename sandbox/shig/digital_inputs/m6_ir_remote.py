...
def handle_red_up_1(button_state, robot):
    ...
    """
    if button_state:
        robot.Leds.set_color(ev3.Leds.LEFT, ev3.Leds.GREEN)
        robot.left_motor.run_forever(speed_sp=600)
    else:
        robot.Leds.set_color(ev3.Leds.LEFT, ev3.Leds.BLACK)
...
def handle_red_down_1(button_state, robot):
    ...
    """
    if button_state:
        robot.Leds.set_color(ev3.Leds.LEFT, ev3.Leds.RED)
        robot.left_motor.run_forever(speed_sp=-600)
    else:
        robot.Leds.set_color(ev3.Leds.LEFT, ev3.Leds.BLACK)
        robot.left_motor.stop()
...
def handle_blue_up_1(button_state, robot):
    ...
    """
    if button_state:
        robot.Leds.set_color(ev3.Leds.RIGHT, ev3.Leds.GREEN)
        robot.right_motor.run_forever(speed_sp=600)
    else:
        robot.Leds.set_color(ev3.Leds.RIGHT, ev3.Leds.BLACK)
...
def handle_blue_down_1(button_state, robot):
    ...
    """
    if button_state:
        robot.Leds.set_color(ev3.Leds.RIGHT, ev3.Leds.RED)
        robot.right_motor.run_forever(speed_sp=-600)
    else:
        robot.Leds.set_color(ev3.Leds.RIGHT, ev3.Leds.BLACK)
        robot.right_motor.stop()
