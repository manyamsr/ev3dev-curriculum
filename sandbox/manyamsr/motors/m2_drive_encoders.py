...
# DONEN: 2. Copy the contents of your m1_drive_timed.py and paste that text into this file below these comments.
...
def main():
    ...
    while True:
        ...
        if dist == 0:
            break
        degrees_per_inch = 90
        motor_turns_needed_in_degrees = dist * degrees_per_inch
